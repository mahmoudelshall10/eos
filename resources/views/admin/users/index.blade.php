            ...
            <div class="col-lg-12">
                <div class="sparkline13-list shadow-reset">
                    ...
                    <div class="main-sparkline13-hd">
                            <h1>Users <span class="table-project-n">Data</span> Table  @can('admin.users.create')<a href="{{route('admin.users.create')}}" class="btn btn-primary">Create</a>@endcan</h1> 
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="modal fade" id="deModal{{$user->id}}" role="dialog">
                                                ...
                                                @can('admin.users.updatePassword')
